...
module.exports = {
    ...
    bigQuery: {
        countries_to_normalize: process.env.BIGQUERY_COUNTRIES_TO_NORMALIZE || "%KOREA%-SOUTH KOREA;IRAN (ISLAMIC REPUBLIC OF)-IRAN;REPUBLIC OF IRELAND-IRELAND;UNITED KINGDOM-UK;REPUBLIC OF MOLDOVA-MOLDOVA;CONGO (KINSHASA)-CONGO KINSHASA;CONGO (BRAZZAVILLE)-CONGO BRAZZAVILLE;MAINLAND CHINA-CHINA;BAHAMAS, THE-BAHAMAS;HONG KONG SAR-HONG KONG;GAMBIA, THE;TAIWAN*-TAIWAN; AZERBAIJAN-AZERBAIJAN"
    }
};
